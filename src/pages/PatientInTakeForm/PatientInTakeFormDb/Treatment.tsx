            ...
            {getAnswer(questionIds.treatmentstatus) === "Yes" && (
              <>
                  ...
                  {(getAnswer(questionIds.Neoadjuvant) === "Done" ||
                    ...
                    <>
                      ...
                      <div className="ml-4.5 mt-0 lg:mt-2 flex gap-3 h-[auto] lg:h-[40px] items-center">
                        ...
                        />
                        <div className="font-semibold text-sm ">
                          Hormonal therapy Herceptin (for HER2-positive
                          cancers), Tamoxifen, Aromatase inhibitors (e.g.,
                          Anastrozole), or others
                        </div>
                      </div>
                ...
                >
                  {/*d. Cryoablation*/}
                  <MultiOptionRadioGroup
                    label="d. Cryoablation"
                    questionId={questionIds.adjcryoblation}
                    formData={formData}
                    //   className="flex flex-col lg:flex-row gap-3 mt-3"
                    handleInputChange={handleInputChange}
                    options={[
                ...
                >
                  ...
                  <MultiOptionRadioGroup
                    label="e. Other"
                    questionId={questionIds.adjother}
                    formData={formData}
                    //   className="flex flex-col lg:flex-row gap-3 mt-3"
                    handleInputChange={handleInputChange}
                    options={[
                  ...
                  <Input
                    type="text"
                    className="w-55 ml-3"
                    value={getAnswer(questionIds.adjotherspecify)}
                    onChange={(e) =>
                      handleInputChange(
                        questionIds.adjotherspecify,
                        e.target.value
                      )
                    }
                    placeholder="Specify"
