...
const AbnormalFindings: React.FC<Props> = ({
  ...
  const renderSizeOfAbnormalitySection = (
    ...
    return (
      <div className="flex flex-col gap-1 ">
        <Label className="font-bold text-base">Size of abnormality</Label>
  ...
  const renderBiRadsSection = (
    ...
    return (
      <div className="flex flex-col gap-1 ">
        <Label className="font-bold text-base">BI-RADS category assigned</Label>
        <div className="ml-4 mt-3 flex flex-row gap-3 flex-wrap">
          {["0", "1", "2", "3", "4a", "4b", "4c", "5", "Unknown", "Other"].map(
            (option) => (
              <div
                key={option}
          ...
          <div className="flex flex-col lg:flex-row gap-2">
            ...
            <div className="w-65 ml-4 lg:ml-0">
              ...
              <Input
                value={getAnswer(questionIds.abnormality)}
                onChange={(val) =>
                  handleInputChange(questionIds.abnormality, val.target.value)
                }
          ...
          <div className="flex-col gap-4 relative">
            ...
            <div className="ml-4 flex flex-col space-x-2 gap-1 mt-3">
              ...
              <div className="flex gap-3 h-[40px] items-center">
                ...
                />
                <Label>Architectural distortion</Label>
              </div>
              <div className="flex gap-3 h-[40px] items-center">
                <Checkbox2
              ...
              <div className="flex gap-3 h-[40px] items-center">
                ...
                />
                <Label>Fibrocystic changes</Label>
              </div>
              {/* <div className="flex gap-3 h-[40px] items-center">
                <Checkbox2
                  checked={
              ...
              <div className="flex gap-3 items-center h-[40px]">
                ...
                />
                <Label>Atypical Hyperplasia</Label>
              </div>
              ...
              <div className="flex flex-col items-start gap-4 relative">
                ...
                {getAnswer(questionIds.breastRight) === "true" && (
                  <div className="ml-6 flex flex-col gap-4 border-b-2 border-gray-200 pb-4">
                    ...
                    {renderSizeOfAbnormalitySection(
                      "Right",
                      questionIds.sizeStatusRight,
                      questionIds.sizeRight,
                      questionIds.sizeunitRight
                    )}

                    {/* F. BI-RADS Category (Right) */}
                    {renderBiRadsSection(
                      "Right",
                      questionIds.biradsCatRight,
                      questionIds.biradsCatOtherRight
                    )}
                  </div>
                )}
                <div className="flex items-center gap-2">
                ...
                {getAnswer(questionIds.breast) === "true" && (
                  <div className="ml-6 flex flex-col gap-4">
                    ...
                    {renderSizeOfAbnormalitySection(
                      "Left",
                      questionIds.sizeStatus,
                      questionIds.size,
                      questionIds.sizeunit
                    )}

                    {/* F. BI-RADS Category (Left) */}
                    {renderBiRadsSection(
                      "Left",
                      questionIds.biradsCat,
