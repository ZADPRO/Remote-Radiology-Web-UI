      ...
      {getAnswer(questionIds.ComparisonPriorRight) === "Present" && (
        <div className="py-4 lg:px-10 space-y-4">
          <div>
            <div
              className={
                "flex gap-0 h-auto lg:h-[40px] items-start lg:items-center"
              }
            >
          ...
          <div>
            <div
              className={
                "flex flex-wrap gap-4 lg:gap-0 h-auto lg:h-[40px] items-start lg:items-center"
              }
            >
              <Label className="font-semibold text-base w-full lg:w-50 flex flex-wrap lg:items-center">
                <span>Doubling Time Range</span>
              </Label>
              <div className="flex flex-wrap gap-0 h-auto lg:h-[40px] items-start lg:items-center">
