...
const ManageRadiologist: React.FC = () => {
  ...
  const getAllRadiologists = async () => {
    setLoading(true);
    try {
      const res = await radiologistService.listAllRadiologists();
      ...
      <div className="w-11/12 mx-auto my-0 space-y-3 py-4">
        ...
        >
          ...
          <Button
            ...
            onClick={() => navigate("../addRadiologist")}
          >
            <Plus /> Add Radiologist
          </Button>
        </div>
...
export default ManageRadiologist;