...
const InformedConsent: React.FC = () => {
  ...
  return (
    <DialogContent
      ...
      className="w-[100vw] h-[90vh] overflow-y-auto p-0"
    >
      <DialogHeader className="bg-[#f6ede7] font-[Poppins] flex items-center justify-between py-2">
        {/* Logo (Left) */}
        ...
        {/* Centered Content */}
        <div className="w-full flex-1 text-center bg-[#eac9c5] py-5">
          <h2 className="text-xl font-bold">QT Technologist Guidelines</h2>
        </div>

      </DialogHeader>
      <div className="w-full h-auto mx-auto px-5 lg:px-10">
        <div className="border rounded-md mb-5 border-[#3F3F3D80]">
          <div className="bg-[#e9e7e3] mx-3 lg:mx-10 mt-5 rounded-md p-6">
            ...
            </div>
            {
              [
                ...
                <>
                  <div className="ml-3 flex gap-2 mt-[0.4rem] text-sm font-normal text-justify">
                    <div className="text-xs"><CircleSmall /></div>
                    <div>{data}</div>
                  </div>
                </>
              ))
          ...
          <div className="bg-[#e9e7e3] mx-3 lg:mx-10 mt-5 mb-5 rounded-md p-6">
            <div className="text-sm flex gap-3 font-normal text-justify">
              <div><b>Remember:</b> QT imaging is a supplementary tool designed to assist healthcare providers in breast imaging assessment. Always operate within FDA-approved indications and maintain the highest standards of patient care and safety</div>
            </div>
          </div>
