...
const ManageScribe: React.FC = () => {
  ...
  const [selectedScribeId, setSelectedScribeId] = useState<number | null>(null);
  ...
  const getAllScribe = async () => {
    setLoading(true);
    try {
      const res = await scribeService.listAllScribe();
  ...
  const table = useReactTable<ListAllScribe>({
    data: scribes,
    columns,
    state: {
      sorting,
  ...
  return (
    <div className="w-full mx-auto">
                  ...
                  {headerGroup.headers.map((header) => (
                    <TableHead
                      ...
                      style={{
                        ...
                        minWidth:
                          (header.column.columnDef as ColumnDef<ListAllScribe>)
                            .minSize || "auto",
                        maxWidth:
                          (header.column.columnDef as ColumnDef<ListAllScribe>)
                            .maxSize || "auto",
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        ...
        >
          <DialogTitle>Edit Scribe</DialogTitle>

          {selectedScribeId !== null && (
            <EditScribe
              scribeId={selectedScribeId}
              setIsEditDialogOpen={setIsEditDialogOpen}
              onUpdate={getAllScribe}
            />
          )}
        </DialogContent>
      </Dialog>
